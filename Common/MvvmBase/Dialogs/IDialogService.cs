...
namespace Common.MvvmBase.Dialogs
{
	...
	public interface IDialogService
	{
        ...
        /// A nullable value of type bool that signifies how a window was closed by the user.
        /// </returns>
        CustomWindow ShowTrayWindow(object ownerViewModel, object viewModel);
        ...
        /// <returns>Dialog result with exit interface</returns>
        IDialog ShowCustomCloseDialog(object ownerViewModel, object viewModel);
	}
}
